CREATE TABLE T_CENTRO (
    ...
    correo_electronico VARCHAR(150) not null            -- Ej: Email
);
...
CREATE TABLE T_PROYECTO (
	...
	fecha_fin DATE NULL, 
	proyecto_stem boolean not null default false,
    ambito VARCHAR(20) not null check(ambito in ('Europeo', 'Español', 'Comunitario', 'Municipal', 'Centro')),             -- Ej: "Madrid-Capital"
...
insert into T_TIPO_NOTIFICACION 
	values ('AVI', 'Aviso'),
			('IMP', 'Importante'),
			('URG', 'Urgente'),
...
VALUES 
('2021-2022', '2021-09-01', '2022-08-31', 'Curso 2021/2022'),
...
-- Insertar Proyectos
INSERT INTO T_PROYECTO (nombre, descripcion, id_centro, fecha_inicio, proyecto_stem, ambito)
VALUES
('Hiperbaric', 'Proyecto Hiperbaric, alumnos de 1º de grado medio de electromecánica de vehículos.', 3, '2022-11-01', false, 'Europeo'),
('EcoMotors', 'Proyecto de construcción de un vehículo eléctrico de bajo costo.', 3,'2020-11-01', true, 'Europeo'),
('Speedster', 'Desarrollo de un coche de carreras eléctrico de alto rendimiento.', 3,'2021-11-01', true, 'Europeo'),
('Taller de Robótica Escolar', 'Diseño y construcción de robots para competencias locales.', 1, '2022-10-01', true, 'Europeo'),
('Laboratorio Verde', 'Creación de un huerto escolar con sensores automatizados.', 1, '2023-01-15', true, 'Europeo'),
('Cine y Sociedad', 'Análisis de cine social en tutorías y asignaturas de valores.', 1, '2022-03-10', false, 'Europeo'),
('Revista Digital Escolar', 'Elaboración de una publicación digital con contenido estudiantil.', 1, '2023-11-05', false, 'Europeo'),
('Proyecto STEM Talent', 'Desarrollo de proyectos integrados de Ciencia y Tecnología.', 2, '2022-09-20', true, 'Europeo'),
('Energía Limpia', 'Diseño de prototipos de energías renovables caseras.', 2, '2023-02-12', true, 'Europeo'),
('Fotografía Documental', 'Talleres de fotografía centrados en la vida cotidiana.', 2, '2021-11-18', false, 'Europeo'),
('Escape Room Educativo', 'Diseño de una sala de escape temática de Historia.', 2, '2023-04-25', false, 'Español'),
('Biotecnología Escolar', 'Técnicas básicas de biotecnología adaptadas a ESO.', 3, '2022-10-15', true, 'Español'),
('EcoMotors 2.0', 'Continuación y mejora del proyecto de vehículo eléctrico.', 3, '2023-10-01', true, 'Español'),
('Podcast Escolar', 'Grabación y edición de podcasts semanales por los alumnos.', 3, '2021-04-01', false, 'Español'),
('Foro de Humanidades', 'Conferencias y debates sobre temas éticos y sociales.', 3, '2020-12-10', false, 'Comunitario'),
('Música y Tecnología', 'Producción de música con herramientas digitales.', 4, '2021-10-01', true, 'Comunitario'),
('Estación Meteorológica', 'Montaje de una estación con Arduino y sensores.', 4, '2023-03-01', true, 'Comunitario'),
('Inclusión y Diversidad', 'Campañas de sensibilización dentro del centro.', 4, '2022-02-14', false, 'Comunitario'),
('Cómic Educativo', 'Creación de un cómic colaborativo de temas escolares.', 4, '2023-05-05', false, 'Comunitario'),
('Movilidad Sostenible', 'Estudio de rutas seguras en bicicleta al instituto.', 5, '2021-09-01', false, 'Comunitario'),
('Laboratorio de Física Aplicada', 'Talleres prácticos de física y matemáticas.', 5, '2023-01-20', true, 'Municipal'),
('Periodismo Escolar', 'Creación de noticiarios por estudiantes.', 5, '2022-05-11', false, 'Municipal'),
('Debate Intercentros', 'Competencia de debate con otros IES de la zona.', 5, '2023-12-01', false, 'Municipal'),
('Construcción de Drones', 'Diseño de drones básicos con impresión 3D.', 30, '2022-02-01', true, 'Centro'),
('Club de Lectura Crítica', 'Análisis literario de obras contemporáneas.', 30, '2023-04-01', false, 'Centro'),
('Proyecto Hidroponía', 'Cultivo sin suelo en instalaciones del centro.', 31, '2023-02-15', true, 'Centro'),
('Hackatón Escolar', 'Competición intensiva de desarrollo de apps educativas.', 31, '2022-11-20', true, 'Centro'),
('Taller de Radio Escolar', 'Producción de programas de radio semanales.', 32, '2021-03-22', false, 'Centro'),
('Realidad Aumentada en Historia', 'Aplicación de AR para estudiar civilizaciones antiguas.', 32, '2023-09-15', true, 'Centro'),
('Robótica con LEGO', 'Iniciación a la programación mediante kits LEGO Mindstorms.', 33, '2022-05-05', true, 'Europeo'),
('Cortos Escolares', 'Grabación de cortometrajes educativos por alumnos.', 33, '2023-11-11', false, 'Español'),
('Proyecto EcoRecicla', 'Campaña de reciclaje con clasificación automática de residuos.', 34, '2021-12-01', true, 'Comunitario'),
('Simulación Empresarial', 'Creación de una cooperativa escolar ficticia.', 34, '2023-06-20', false, 'Municipal'),
('Taller Arduino Básico', 'Iniciación al hardware libre con Arduino.', 6, '2023-10-10', true, 'Centro'),
('Viaje Científico Virtual', 'Visitas online a laboratorios y centros de investigación.', 7, '2021-11-01', true, 'Europeo'),
('Redacción Periodística', 'Taller de redacción y edición de textos de actualidad.', 8, '2022-05-01', false, 'Español'),
('Matemáticas Cotidianas', 'Aplicación de matemáticas en la vida diaria.', 9, '2023-02-01', true, 'Comunitario'),
('Cultura y Gastronomía', 'Estudio de la cocina como manifestación cultural.', 10, '2021-09-15', false, 'Municipal'),
('Jóvenes Científicos', 'Feria de ciencia organizada por estudiantes.', 11, '2022-04-10', true, 'Centro'),
('Taller de Cine en Inglés', 'Realización de cortos en inglés.', 12, '2023-01-15', false, 'Centro'),
('Realidad Virtual en Aula', 'Proyectos con gafas VR en Historia y Geografía.', 13, '2023-03-15', true, 'Europeo'),
('Biohuerto Escolar', 'Huerto ecológico y compostaje.', 14, '2021-10-10', true, 'Español'),
('Club de Ajedrez', 'Torneos y talleres de ajedrez lógico.', 15, '2022-09-20', false, 'Comunitario'),
('Modelado 3D', 'Diseño e impresión de modelos 3D.', 16, '2023-05-05', true, 'Municipal'),
('Arte Urbano', 'Taller de graffiti y muralismo con fines educativos.', 17, '2021-03-01', false, 'Centro'),
('Rutas Históricas', 'Estudio de la historia local mediante visitas.', 18, '2022-11-11', false, 'Europeo'),
('Taller de Emprendimiento', 'Creación de planes de negocio simples.', 19, '2023-07-01', false, 'Español'),
('Taller de Debate y Oratoria', 'Técnicas de expresión oral y pensamiento crítico.', 20, '2022-10-01', false, 'Comunitario'),
('Tecnología Responsable', 'Uso ético de las TIC en la adolescencia.', 21, '2023-01-15', false, 'Municipal'),
('Diseño de Juegos Educativos', 'Creación de juegos de mesa para aprender contenidos.', 22, '2022-03-10', false, 'Centro'),
('Historia Interactiva', 'Proyectos digitales sobre historia.', 23, '2021-12-12', true, 'Europeo'),
('Lectura Compartida', 'Programa de lectura entre niveles educativos.', 24, '2023-04-01', false, 'Español'),
('Redacción Académica', 'Técnicas para escribir ensayos argumentativos.', 25, '2022-05-01', false, 'Comunitario'),
('Medioambiente y Cambio Climático', 'Estudios locales sobre impacto ambiental.', 26, '2023-06-06', true, 'Municipal'),
('Aula del Futuro', 'Diseño de espacios flexibles de aprendizaje.', 27, '2022-07-01', false, 'Centro'),
('Arte y Emoción', 'Educación emocional a través del arte.', 28, '2023-03-03', false, 'Europeo'),
('Taller de Ilustración', 'Introducción al diseño gráfico e ilustración.', 29, '2021-10-15', false, 'Español');

INSERT INTO T_PROYECTO (nombre, descripcion, fecha_inicio, proyecto_stem, ambito)
VALUES
('Innovación Educativa Europea', 'Proyecto de colaboración para metodologías innovadoras a nivel europeo.', '2024-09-01', true, 'Europeo'),
('Patrimonio Cultural Español', 'Investigación y difusión del patrimonio histórico español.', '2024-10-15', false, 'Europeo'),
('Huertos Comunitarios Urbanos', 'Creación de espacios verdes educativos en la comunidad.', '2025-01-20', true, 'Europeo'),
('Festival de Teatro Municipal', 'Organización de un festival de teatro con centros locales.', '2025-03-01', false, 'Europeo'),
('Club de Ciencia del Centro', 'Actividades extracurriculares para fomentar vocaciones científicas.', '2024-11-05', true, 'Europeo'),
('Desarrollo Sostenible Español', 'Iniciativas para la concienciación sobre sostenibilidad a nivel nacional.', '2024-12-10', true, 'Español'),
('Intercambio Juvenil Comunitario', 'Programa de intercambio cultural entre jóvenes de la comunidad.', '2025-02-15', false, 'Español'),
('Olimpiadas Matemáticas Municipales', 'Competición matemática para estudiantes de la localidad.', '2025-04-01', true, 'Comunitario'),
('Seminario de Historia del Centro', 'Ciclo de conferencias sobre historia local para la comunidad educativa.', '2024-09-25', false, 'Municipal'),
('Taller de Programación del Centro', 'Introducción a la programación para alumnos del instituto.', '2024-10-01', true, 'Centro');
...
((SELECT identificador FROM T_PATROCINADOR WHERE nombre = 'Fibritel'), 2, '2023-2024', '2024-09-16', 1800.00, NULL),
((SELECT identificador FROM T_PATROCINADOR WHERE nombre = 'Karting Ángel Burgueño'), 2, '2023-2024', '2024-09-17', 1000.00, NULL),
...
((SELECT identificador FROM T_PATROCINADOR WHERE nombre = 'Hidroponia España'), 5, '2024-2025', '2024-09-15', 1600.00, NULL),
((SELECT identificador FROM T_PATROCINADOR WHERE nombre = 'Ikea'), 5, '2024-2025', '2024-09-20', 1200.00, NULL),
...
((SELECT identificador FROM T_PATROCINADOR WHERE nombre = 'Microsoft'), 34, '2024-2025', '2024-09-10', 1500.00, NULL),
((SELECT identificador FROM T_PATROCINADOR WHERE nombre = 'RS Components'), 34, '2024-2025', '2024-09-12', 950.00, NULL),
...
((SELECT identificador FROM T_PATROCINADOR WHERE nombre = 'Banco Santander'), 47, '2023-2024', '2023-09-10', 2500.00, 'Patrocinio para fomentar el emprendimiento escolar.'),
((SELECT identificador FROM T_PATROCINADOR WHERE nombre = 'Google for Startups'), 47, '2023-2024', '2023-09-12', 1300.00, 'Apoyo al desarrollo de ideas innovadoras.'),
...
((SELECT identificador FROM T_PATROCINADOR WHERE nombre = 'Google for Startups'), 47, '2024-2025', '2024-09-14', 1900.00, NULL),
