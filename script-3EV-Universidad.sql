...
create table notificacion(
	...
	texto text not null,
	codigo_tipo_notificacion char(3) not null,
	fecha_notificacion timestamp default current_timestamp,
	constraint FK_NOTIFICACION_TIPO
		foreign key (codigo_tipo_notificacion) references tipo_notificacion(cod_tipo_notificacion)
);
...
(24, '12345678A', 'María', 'García', 'López', 'Madrid', 'Calle Principal 123', '912345678', '1980-05-15', 'M', 20),
...
INSERT INTO asignatura VALUES (93, 'Probabilidad y Estadística para Ciencias de la Computación', 6, 'básica', 1, 1, 21 );
...
INSERT INTO curso_escolar VALUES (11, to_date(2024::text, 'YYYY'), to_date(2025::text, 'YYYY'));
...
INSERT INTO alumno_curso_asignatura VALUES (24, 11, 5);
...
INSERT INTO alumno_curso_asignatura VALUES (23, 11, 5);
...
INSERT INTO alumno_curso_asignatura VALUES (19, 11, 5);
...
INSERT INTO alumno_curso_asignatura VALUES (28, 89, 9), (28, 90, 9), (28, 91, 10), (28, 92, 10), (28, 91, 11), (28, 92, 11);
...
INSERT INTO alumno_curso_asignatura VALUES (32, 91, 11), (32, 92, 11), (32, 23, 11), (32, 24, 11),(32, 1, 11), (32, 2, 11), (32, 4, 11), (32, 5, 11);
INSERT INTO alumno_curso_asignatura VALUES (33, 90, 9), (33, 91, 10), (33, 92, 10), (33, 91, 11), (33, 92, 11);
INSERT INTO alumno_curso_asignatura VALUES (34, 89, 9), (34, 90, 9), (33, 23, 10),(33, 24, 10), (33, 23, 11),(33, 24, 11);
